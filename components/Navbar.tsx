    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <a
            href="/"
            className="flex items-center gap-3 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-navy rounded-sm"
          >
            <div className="w-9 h-9 bg-brand flex items-center justify-center rounded-sm shadow-md shadow-brand/30">
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 bg-wa hover:bg-wa/90 text-white text-sm font-semibold px-4 py-2 rounded-md transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wa"
            >
              ...
              <SheetContent side="left" className="bg-navy border-r border-white/10 w-64 px-6 pt-10">
                <div className="flex flex-col gap-8">
                  <a href="/" className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-brand flex items-center justify-center rounded-sm shrink-0 shadow-md shadow-brand/30">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-wa hover:bg-wa/90 text-white text-sm font-semibold px-4 py-3 rounded-md transition-colors min-h-[44px]"
                  >
                    <MessageCircle size={15} />
                    WhatsApp
                  </a>
