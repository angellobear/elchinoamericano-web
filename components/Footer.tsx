...
const CATEGORIES = [
  { label: "Motor", id: "motor" },
  { label: "Frenos", id: "frenos" },
  { label: "Suspensión", id: "suspension" },
  { label: "Filtros", id: "filtros" },
  { label: "Carrocería", id: "carroceria" },
  { label: "Enfriamiento", id: "enfriamiento" },
]

const ALL_BRANDS = [...chineseBrands, ...americanBrands]
