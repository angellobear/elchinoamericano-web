...
export default function CtaBand() {
  return (
    <section className="relative overflow-hidden bg-brand py-16 px-4 sm:px-6 lg:px-8">
      {/* white radial glow */}
      <div
        className="absolute -right-20 -top-32 w-[520px] h-[520px] rounded-full pointer-events-none"
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[.16em] text-white/80 mb-3">
          ...
          <p className="mt-3.5 max-w-lg text-white/[.92] text-[1.0625rem] leading-[1.55]">
