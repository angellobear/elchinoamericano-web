...
export function VehicleBrandForm({
  ...
  return (
    ...
    >
      ...
      />
      <FormActions>
        <SubmitButton className={`${compact ? 'w-full ' : ''}px-5 py-2 bg-navy text-white text-sm rounded-lg hover:bg-navy-dark transition-colors font-medium disabled:opacity-60`}>
