...
export async function GET() {
  ...
  const lines = [
    ...
    `> ${SITE_URL}`,
    "",
    "El Chino Americano es una tienda de repuestos automotrices en Ecuador especializada en vehículos chinos y americanos.",
    "Ofrece repuestos originales, OEM y alternos, con asesoría por WhatsApp y envíos a nivel nacional.",
    "",
    "## Primary Pages",
    `- Inicio: ${SITE_URL}/`,
