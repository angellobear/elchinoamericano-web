...
ALTER TABLE "product_compatibilities" ADD CONSTRAINT "product_compatibilities_vehicle_model_id_vehicle_models_id_fk" FOREIGN KEY ("vehicle_model_id") REFERENCES "public"."vehicle_models"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_equivalencies" ADD CONSTRAINT "product_equivalencies_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_equivalencies" ADD CONSTRAINT "product_equivalencies_equivalent_id_products_id_fk" FOREIGN KEY ("equivalent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "products" ADD CONSTRAINT "products_part_brand_id_part_brands_id_fk" FOREIGN KEY ("part_brand_id") REFERENCES "public"."part_brands"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vehicle_models" ADD CONSTRAINT "vehicle_models_brand_id_vehicle_brands_id_fk" FOREIGN KEY ("brand_id") REFERENCES "public"."vehicle_brands"("id") ON DELETE cascade ON UPDATE no action;